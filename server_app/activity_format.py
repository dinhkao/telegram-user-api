...
_SCOPE_LABEL = {"order": "Đơn", "production": "Phiếu SX", "box": "Thùng", "place": "Vị trí",
                ...
                "bean_place": "Kho đậu", "bean_stocktake": "Kiểm kho đậu"}
...
_PAIRS = {
    ...
    "POST /api/returns/{id}/handle-goods": ("return.goods_handled",),
    "POST /api/returns/{id}/goods/revert": ("return.goods_reverted",),
    ...
    "POST /api/quality/{id}/report": ("quality.report_created",),
    "POST /api/quality/report/{rid}/delete": ("quality.report_deleted",),
