...
MAX_COPIES = 5
# Lề trắng nướng vào ảnh PNG (px ở 96dpi). SIDE = 2 cạnh DÀI của tờ giấy — ngoài dòng
# "Người gửi" và ngoài dòng ghi chú — chỗ nhân viên quét keo dán lên thùng không đè
