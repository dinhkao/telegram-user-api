...
from server_app.order_suggest_routes import order_code_stock_handler, orders_suggest_handler
...
def create_app():
    ...
    from server_app.production_overtime_routes import set_overtime_handler
    ...
    r.add_post("/api/production/{thread_id}/overtime", set_overtime_handler)     # bật/tắt tăng ca 1 thợ (office)
    ...
    from server_app.fcm_routes import fcm_register_handler, fcm_unregister_handler
    r.add_post("/api/fcm/register", fcm_register_handler)
    r.add_post("/api/fcm/unregister", fcm_unregister_handler)   # đăng xuất: máy thôi nhận push
