...
def create_app():
    ...
    from server_app.production_dashboard_routes import production_report_dashboard_handler, production_worker_report_handler, production_payslips_html_handler, production_wage_pivot_handler
