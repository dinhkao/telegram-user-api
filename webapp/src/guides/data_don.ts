    ...
    sections: [
      ...
      { title: "Trang thu tiền của đơn (đơn ẩn)", html: `
        ...
        <ul>
          ...
          <li>Đơn ẩn <b>vẫn nằm ngay trong danh sách “Chọn đơn nhận thanh toán”</b>, <b>đúng vị trí theo thời gian</b> —
        ...
        <p class="muted small">Muốn danh sách gọn thì bấm <b>「Ẩn lại」</b> cạnh nút sắp xếp — các đơn ẩn gom về khối
        <b>“Đã ẩn khỏi trang thu tiền”</b> cuối trang. Xem toàn cảnh đơn ẩn của mọi khách ở trang
        <a href="#/huong-dan/thu-tien">Thu tiền hàng loạt</a>.</p>` },
    ...
    sections: [
      ...
      { title: "Tạo & sửa nháp", html: `
        <ol>
          ...
          <li>Cần giảm giá → <b>「Thêm chiết khấu」</b>: dòng <b>CK</b> <b>trừ thẳng vào tiền hàng trước thuế</b>
            (thuế tính trên số đã trừ). Chọn <b>Số tiền</b> (gõ thẳng, tự đặt nội dung) hoặc <b>%</b>
            (gõ %, tiền = % × tổng các dòng hàng, tên tự sinh dạng
            "Chiết khấu thương mại 5%, số tiền 1.401.250 đồng" — đổi SL/giá hàng là tiền CK tự chạy theo). Trên hoá đơn VNPT in thành dòng
        ...
        <b>Xoá nháp</b> = admin. Nút <b>「Xem」</b> mở bản thể hiện <b>ngay trong app</b> (zoom/vuốt như ảnh đơn);
