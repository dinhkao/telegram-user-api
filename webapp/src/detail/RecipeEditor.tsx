...
// thành phẩm). Nhu cầu NL theo LOẠI PHIẾU: sản xuất = không cần, đóng gói = bắt
// buộc đủ MỌI NL (chọn thùng NL lúc nhập → trừ kho). Định nghĩa tỉ lệ ở đây
// (trang chi tiết SP). Data: /api/products/{code}/recipe.
...
export function RecipeEditor({ productCode }: { productCode: string }) {
  ...
  return (
    <section class="card">
      ...
      <div class="muted small" style={{ marginBottom: "6px" }}>Tỉ lệ = lượng nguyên liệu cho 1 {unit} {productCode}. Chỉ phiếu ĐÓNG GÓI mới bắt buộc trừ nguyên liệu (chọn thùng NL lúc nhập); phiếu sản xuất không cần.</div>
