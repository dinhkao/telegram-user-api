      ...
      <tbody>
        ...
        {!hasFees && d === 0 ? (
          ...
          <>
            ...
            {p ? <tr class="sub"><td colSpan={2}>PVC</td><td class="num">+{money(p)}</td></tr> : null}
            {v ? <tr class="sub"><td colSpan={2}>VAT</td><td class="num">+{money(v)}</td></tr> : null}
            {disc ? <tr class="sub"><td colSpan={2}>Giảm giá</td><td class="num">−{money(disc)}</td></tr> : null}
            {d !== 0 && hasFees ? <tr class="sub"><td colSpan={2}>Tổng đơn này</td><td class="num">{money(tongDon)}</td></tr> : null}
            {d !== 0 ? <tr class="sub debt"><td colSpan={2}>Nợ trước</td><td class="num">{money(d)}</td></tr> : null}
