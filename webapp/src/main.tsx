...
import { BeanStocktakes } from "./pages/BeanStocktakes";
import { BeanStocktakeDetail } from "./pages/BeanStocktakeDetail";
...
function App() {
  ...
  const beanStMatch = hash.match(/^#\/kho-dau\/kiem\/(\d+)/);
  ...
  else if (beanStMatch) page = <BeanStocktakeDetail id={beanStMatch[1]} />;
  else if (hash.startsWith("#/kho-dau/kiem")) page = <BeanStocktakes />;
    ...
    <div class="app">
      ...
      {!showLogin && !qualityOnly && (
        <div class="bottom-dock">
          ...
          <a class={tab("#/san_xuat") + " tab-sx"} href="#/san_xuat" onClick={() => fastScrollTop()}><NavSxTag /><span class="tab-lbl">SX</span></a>
